...
@file: test2_multi_Convolution2D.py
@time: 2016/9/27 16:11
...
def test_lena():
    ...
    conv_layer = Convolution2D(input_shape=ims[0].shape, nb_kernel=3, kernel_height=1, kernel_width=2,
                               activation='linear')
    ...
    d_cims = cims
    print 'backwarding...'
    d_ims = conv_layer.backward(d_cims)
